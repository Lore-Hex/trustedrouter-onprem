...
| `reference/openai-compatible-recipes.md` | Verified Fireworks, Modal, and TrustedRouter connection recipes through the openai-compatible provider family. |
| `reference/upstream-sync.md` | Source pin and product invariants for reviewed commit-by-commit upstream synchronization. |
