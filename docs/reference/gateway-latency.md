...
1. the mock directly
2. the TrustedRouterOnPrem native gateway
...
and model, Python version, resolved TrustedRouterOnPrem engine, every repeat, and the
...
`https://raw.githubusercontent.com/Lore-Hex/trustedrouter-onprem/badges/gateway-latency.json`
