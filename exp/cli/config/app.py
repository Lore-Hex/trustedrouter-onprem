...
config_app = typer.Typer(
    help="Manage project-local TrustedRouterOnPrem settings.",
    no_args_is_help=True,
)
add_deferred_typer(
    config_app,
    name="judge",
    module="exp.cli.judge.app",
    attr="judge_app",
...
_PROVIDER_OPTION = typer.Option(
    ...
    help=(
        ...
        "Supported values: trustedrouter, openai, anthropic, gemini, "
