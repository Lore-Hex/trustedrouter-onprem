"""Interactive home screen for the TrustedRouterOnPrem gateway flow."""
...
def default_gateway(
    *,
    ...
    """Show the TrustedRouterOnPrem home screen or start a direct gateway invocation.
...
def _render_home(console: Console) -> None:
    ...
    console.print(Text("TrustedRouterOnPrem gateway", style="dim"))
    console.print()
