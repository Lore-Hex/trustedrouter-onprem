"""TrustedRouter terminal palette shared by every EXP command console.

The palette mirrors the TrustedRouter website: a pale mint accent over dark surfaces, a
