...
FIREWORKS_SCHEME = ReasoningCarrierScheme(
    prefix="x-trustedrouter-onprem-fireworks-reasoning-v2:",
    key_derivation_domain=b"trustedrouter-onprem/fireworks-reasoning-carrier/aes256gcm/v2\0",
    credential_identity_domain=b"trustedrouter-onprem/fireworks-reasoning-credential/v2\0",
    route_sha256_field="fireworks_reasoning_route_sha256",
)

HUNYUAN_SCHEME = ReasoningCarrierScheme(
    prefix="x-trustedrouter-onprem-hunyuan-reasoning-v1:",
    ...
    key_derivation_domain=b"trustedrouter-onprem/hunyuan-reasoning-carrier/aes256gcm/v1\0",
    ...
    credential_identity_domain=b"trustedrouter-onprem/hunyuan-reasoning-credential/v1\0",
